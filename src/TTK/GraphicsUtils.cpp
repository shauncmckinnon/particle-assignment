...
void TTK::Graphics::InitImGUI()
{
	...
	io.KeyMap[ImGuiKey_LeftArrow] = 160 + GLUT_KEY_LEFT;
	io.KeyMap[ImGuiKey_RightArrow] = 160 + GLUT_KEY_RIGHT;
	io.KeyMap[ImGuiKey_UpArrow] = 160 + GLUT_KEY_UP;
	io.KeyMap[ImGuiKey_DownArrow] = 160 + GLUT_KEY_DOWN;
	io.KeyMap[ImGuiKey_PageUp] = 160 + GLUT_KEY_PAGE_UP;
	io.KeyMap[ImGuiKey_PageDown] = 160 + GLUT_KEY_PAGE_DOWN;
	io.KeyMap[ImGuiKey_Home] = 160 + GLUT_KEY_HOME;
	io.KeyMap[ImGuiKey_End] = 160 + GLUT_KEY_END;
	io.KeyMap[ImGuiKey_Escape] = 160 + GLUT_KEY_PAGE_DOWN;
